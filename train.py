...
def savemodel(epoch, nsamples, curmax=False):
    ...
    if curmax: 
        ...
        cur_model.save_weights('%s/f4_star%06d.weights' % (backupdir, epoch))
        cur_model.save_weights('%s/pul_models/ap%06d.weights' % (backupdir, epoch))
        old_wgts = 'npz%s/ap%06d.weights' % (backupdir, epoch-keep_backup*save_interval)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', '-d',
        type=str, default='cfg/yoloFace.data', help='data definition file')
    parser.add_argument('--config', '-c',
        type=str, default='cfg/yoloFace.cfg', help='network configuration file')
    parser.add_argument('--weights', '-w',
        type=str, default='./models/f4_star003000.weights', help='initial weights file')
        # type=str, default='./models/pul_models/ap000990.weights', help='initial weights file')
        # type=str, default='./models/darknet53.conv.74', help='initial weights file')
        # type=str, default='./models/nnp220_000550.weights', help='initial weights file')
        # type=str, default='./models/nnp000410.weights', help='initial weights file')
